...
public class OrderServiceImpl implements OrderService{
     ...
     */
    @Override
    @GlobalTransactional(name = "jxb-create-order",rollbackFor = Exception.class)
    public void create(Order order) {
        ...
        LOGGER.info("------->本地方法:{}",l-startTime);
        //远程方法 扣减库存
        storageApi.decrease(order.getProductId(),order.getCount());
        long l2 = System.currentTimeMillis();
        LOGGER.info("------->远程方法 扣减库存:{}",l2-l);
        //远程方法 扣减账户余额
        ...
        LOGGER.info("------->扣减账户结束order中:{}",l3-l2);
        LOGGER.info("------->交易结束");
    }
